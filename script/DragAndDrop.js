...
var fig = new Image();
var mario = new Image();
img.src = "mario-img/mario-objects.png";  // Alle Bausteine
fig.src = "mario-img/mario-enemies.png";  // Alle Figuren (außer Mario)
mario.src = "mario-img/mario-sprites.png";  // Mario
switch(obj)
{
	case 'grass_top_1x1':
