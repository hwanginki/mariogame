function multiple_coinbox(i,j)			//Konstruktor einer Vielfach-M�nzbox
{
	this.i = i;							//damit ist die M�nzbox eindeutig identifizierbar
	this.j = j;
	this.x = 32*i;						//world-Koordinaten -> f�r Animation in GameLoop()
	this.y = (14-j)*32;
	this.activated = false;				//wurde die Box schon ausgel�st?
	
	$('#world').append('<div id=\'multiple_coinbox' + i.toString() + '_' + j.toString() + '\'></div>');		//erzeuge div f�r die M�nzbox und setze sie in die Spielwelt ein
	this.body = $('#multiple_coinbox'+i.toString()+'_'+j.toString());										//hiermit l�sst sich das M�nzbox-div ansprechen
	...
	$('#world').append('<div id=\'multiple_coinboxcoin' + i.toString() + '_' + j.toString() + '\'></div>');	//erzeuge div f�r die M�nze hinter der M�nzbox und setze sie in die Spielwelt ein
	this.coin = $('#multiple_coinboxcoin'+i.toString()+'_'+j.toString());									//hiermit l�sst sich das M�nzen-div ansprechen
