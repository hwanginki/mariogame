function staticplant(i,j)				//Konstruktor einer statischen Pflanze
{
	...
	$('#world').append('<div id=\'staticplant' + i.toString() + '_' + j.toString() + '\'></div>');	//erzeuge div f�r die Pflanze und setze sie in die Spielwelt ein
	this.body = $('#staticplant'+i.toString()+'_'+j.toString());									//hiermit l�sst sich das Pflanzen-div ansprechen
	...
	this.body.css( { 'margin' : '0' ,
					 ...
					 'position' : 'absolute' ,					//Positionierung der Pflanze erfolgt relativ zum �bergeordneten world-Div
