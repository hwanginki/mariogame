function ballmonster(i,j)				//Konstruktor eines Kugelmonsters
{
	...
	$('#world').append('<div id=\'ballmonster' + i.toString() + '_' + j.toString() + '\'></div>');	//erzeuge div f�r das Monster und setze es in die Spielwelt ein
	this.body = $('#ballmonster'+i.toString()+'_'+j.toString());									//hiermit l�sst sich das div ansprechen
	...
	this.body.sprite( { fps: 6 , no_of_frames: 2 , rewind: true } );//damit das Monster l�uft
};
...
ballmonster.prototype.move = function()	//das Kugelmonster bewegt sich
{
	...
	if( this.direction==='right' )
		Delta_x = 3;						//entspricht Geschwindigkeit, mit der das Monster l�uft
	else
		Delta_x = -3;
	...
	else if( this.sprite_right && this.direction === 'left' )
	{
		...
		this.body.sprite( { fps: 6 , no_of_frames: 2 } );						//damit das Monster l�uft
